import SQLiteHelper from './SQLiteHelper'; // importing the SQLiteHelper class from the local file './SQLiteHelper.js' to manage database connections and operations

class ExpenseRepository{
    constructor(){
        this.db = SQLiteHelper.getInstance().getWritableDatabase(); // getting a writable database instance from the SQLiteHelper singleton to perform database operations
    }
