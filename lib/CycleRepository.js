...
import SQLiteHelper from './SQLiteHelper'; // importing the SQLiteHelper class from the SQLiteHelper.js file
...
class CycleRepository{
  ...
  export default CycleRepository; // exporting the CycleRepository class so that it can be used in other parts of the application
