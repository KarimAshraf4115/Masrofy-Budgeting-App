import Database from 'better-sqlite3'; // importing the SQLite3 library into Database variable
import path from 'path'; // importing the path module to handle file paths
import fs from 'fs'; // importing the file system module to handle file operations (reading/writing files)
...
class SQLiteHelper {
    ...
    export default SQLiteHelperSingleton; // ensures the singleton pattern of database (put it in function for maintainable code and match ESM standards)